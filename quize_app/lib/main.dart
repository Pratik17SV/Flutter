...
class _HTMLQuizState extends State<HTMLQuiz> {
  ...
  int? _selectedValueQ1, _selectedValueQ2, _selectedValueQ3;
  String _answer = "";
      ...
      body: ListView(
        children: <Widget>[
          ...
          RadioListTile(
            ...
            value: 2, // Assign a value of 2 to this option
            groupValue:
                _selectedValueQ2, // Use _selectedValue to track the selected option
            onChanged: (value) {
              setState(() {
                _selectedValueQ2 =
                    value!; // Update _selectedValue when option 2 is selected
          ...
          //Third Question
          Text(
            'Which tag is used to display line on screen?',
            style: const TextStyle(fontSize: 18),
          ),
          RadioListTile(
            title: Text('<img>'),
          ...
          RadioListTile(
            ...
            value: 2, // Assign a value of 2 to this option
            groupValue:
                _selectedValueQ3, // Use _selectedValue to track the selected option
            onChanged: (value) {
              setState(() {
                _selectedValueQ3 =
                    value!; // Update _selectedValue when option 2 is selected
          ...
          // ),
          Center(child: Text('$marks', style: TextStyle(fontSize: 20))),
        ],
      ),
    );
  }
...
class ScoreScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(child: Text('$marks', style: TextStyle(fontSize: 20))),
    );
  }
}
